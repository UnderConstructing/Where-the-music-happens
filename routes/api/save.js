    ...
    User.findOneAndUpdate({ username: req.body[0].username },
        {
            $push: {
                ...
                melody2RowOne: req.body[0].melody2RowOne,
                melody2RowTwo: req.body[0].melody2RowTwo,
                melody2RowThree: req.body[0].melody2RowThree,
                melody2RowFour: req.body[0].melody2RowFour,
                melody2RowFive: req.body[0].melody2RowFive,
                melody2RowSix: req.body[0].melody2RowSix,
                melody2RowSeven: req.body[0].melody2RowSeven,
                melody2RowEight: req.body[0].melody2RowEight,
                melody2RowNine: req.body[0].melody2RowNine,
